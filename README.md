...
## Environments
- Preview: https://main--test1234--shilpatty.aem.page/
- Live: https://main--test1234--shilpatty.aem.live/
...
1. Open the `test1234` directory in your favorite IDE and start coding :)
